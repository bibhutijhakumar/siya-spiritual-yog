...
import yogaimg1 from "../../assets/images/yoga-img-1.png";
    ...
    < div className="pt-20">
      ...
      <section className="py-6 bg-white">
        <div className="container-custom grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 items-center px-4 sm:px-6 md:px-8">
          ...
          >
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 text-gray-900">Welcome to <img className="w-20 inline" src={IMAGES.logo} alt="" /><br />SIYA SPIRITUAL YOG</h2>
            <div className="space-y-4 sm:space-y-6 text-gray-600 leading-relaxed text-sm sm:text-base">
              <p>
                Founded on the principles of ancient wisdom and modern therapeutic science, SIYA SPIRITUAL YOG has been a sanctuary for those seeking restoration since 2021. Our journey began with a single vision: to create a space where the soul finds its rhythm and the body finds its strength.
              </p>
              <p>
          ...
          >
            ...
            <div className="absolute -top-6 sm:-top-10 -left-6 sm:-left-10 bg-orange-600 text-white p-4 sm:p-8 rounded-lg sm:rounded-2xl shadow-2xl hidden md:block">
              <div className="text-2xl sm:text-4xl font-bold mb-1">2021</div>
      ...
      {/* Statistics */}
      <section className="py-6 bg-surface-container border-y border-orange-50">
      ...
      <section className="py-6 bg-white">
        <div className="container-custom px-4 sm:px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[IMAGES.pool, IMAGES.room, IMAGES.yog1].map((img, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-6 bg-background">
        <div className="container-custom">
          <div className="bg-gradient-to-tl from-primary-container to-[#d84315] rounded-[2.5rem] p-8 md:p-16 lg:p-24 text-white overflow-hidden relative shadow-3xl">
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 text-orange-800 font-bold text-lg hover:underline transition-all cursor-pointer"
            >
              <Instagram size={20} />
              <span>@siyaspiritualyog</span>
            </a>
          </div>
